...
type SessionClient interface {
	ValidateSession(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *sessionClient) ValidateSession(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/Session/ValidateSession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SessionServer interface {
	ValidateSession(context.Context, *Request) (*Response, error)
...
func (UnimplementedSessionServer) ValidateSession(context.Context, *Request) (*Response, error) {
...
func _Session_ValidateSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Session/ValidateSession",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionServer).ValidateSession(ctx, req.(*Request))
	}
